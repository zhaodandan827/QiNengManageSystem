            ...
            <el-dialog
                ...
                <el-row>
                    <el-table :data="list" border>
                        ...
                        <el-table-column
                                width="150"
                                v-for="(item,i) in columnDate"
                                align='center'>
                            <template slot-scope="scope"  v-for="(item,index) in rowList" >
                                <span>{{rowList[scope.$index].inputValue}}</span>
                                <el-input  v-model="rowList[scope.$index].inputValue" ></el-input>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-row>
...
<script>
    export default {
        ...
        methods:{
            ...
            addNode:function() {
                let item={};
                this.columnDate.push('columnDate1');
                this.rowList.push(
                    {
                        inputValue1:''
                    },
